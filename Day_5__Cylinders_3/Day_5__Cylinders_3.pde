...
Cylinder[] cylinders = {
  ...
  new Cylinder(width/5, height, cyan), 
  new Cylinder(width/5*2, height, magenta), 
  new Cylinder(width/5*3, height, yellow), 
  new Cylinder(width/5*4, height, cyan),
  new Cylinder(width/5*5, height, magenta), 
  new Cylinder(width/5*6, height, yellow), 
  new Cylinder(width/5*7, height, cyan),
  new Cylinder(width/5*8, height, magenta), 
};
